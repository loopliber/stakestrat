    ...
    <div className="bg-gray-50 py-12">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 tracking-tight">Arbitrage Calculator</h1>
          <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
            Find and calculate risk-free betting opportunities (arbs) between two outcomes. This tool is essential for advanced sports bettors.
          </p>
        </div>
